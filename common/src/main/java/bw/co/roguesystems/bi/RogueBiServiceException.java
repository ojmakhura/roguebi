 ...
 * within {@link bw.org.bocra.portal.auth.AuthorisationService}.
 */
public class RogueBiServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = 8302930609604584835L;

    /**
     * The default constructor for <code>AuthorisationServiceException</code>.
     */
    public RogueBiServiceException()
    {
        // Documented empty block
    }

    /**
     * Constructs a new instance of <code>AuthorisationServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public RogueBiServiceException(Throwable throwable)
    {
     ...
     */
    public RogueBiServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public RogueBiServiceException(String message, Throwable throwable)
    {
